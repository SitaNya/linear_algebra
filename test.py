...
class LinearRegressionTestCase(unittest.TestCase):
    ...
    def test_shape(self):
        ...
        for _ in range(10):
            ...
            self.assertEqual(ma.shape(matrix.tolist()), (r, c), 'Wrong answer')
    ...
    def test_matxMultiply(self):
        ...
        with self.assertRaises(ValueError, msg="Matrix A\'s column number doesn\'t equal to Matrix b\'s row number"):
            ma.matxMultiply(mat1.tolist(), mat2.tolist())
        with self.assertRaises(ValueError, msg="Matrix A\'s column number doesn\'t equal to Matrix b\'s row number"):
    ...
    def test_gj_Solve(self):
        ...
        for _ in range(9999):
            ...
            x = li.gj_Solve(A.tolist(), b.tolist(), epsilon=1.0e-8)
